...
#add a column in Test Dataset
test$Item_Outlet_Sales <- 1
View(test)

#combine the data set for same number of columns and rows in both datasets
...
#check variable class - Structure of Dataset
str(my_data)
...
prin_comp <- prcomp(pca.train, scale. = T) #scale. = t is Normalising the data
names(prin_comp)
...
#we are interested in first 31 PCAs
train.data <- train.data[,1:32]
